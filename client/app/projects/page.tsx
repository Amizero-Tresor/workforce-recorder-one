    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#171717] flex">
      ...
      <div className="flex-1 flex flex-col lg:ml-0">
        ...
        <main className="flex-1 p-4 lg:p-6">
          <div className="mb-6">
            <h1 className="text-lg lg:text-2xl font-semibold text-gray-900 dark:text-white">My Projects</h1>
            <p className="text-sm lg:text-base text-gray-600 dark:text-gray-300">Projects you're currently assigned to and your work history</p>
          </div>

          {projects.length === 0 ? (
            <div className="bg-white dark:bg-[#171717] rounded-lg shadow-sm p-8 lg:p-12 text-center border border-gray-200 dark:border-gray-700">
              <FolderOpen className="mx-auto h-12 w-12 text-gray-400 dark:text-gray-500" />
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No projects assigned</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
              {projects.map((project) => (
                <div key={project.id} className="bg-white dark:bg-[#171717] rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200">
                  <div className="p-4 lg:p-6">
                    ...
                    <div className="mt-4 lg:mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                      <button 
      ...
      >
        <div className="space-y-4 lg:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 lg:p-4 text-center">
              <div className="text-xl lg:text-2xl font-bold text-blue-600 dark:text-blue-400">
                {projectTimeLogs.length}
              </div>
              <div className="text-xs lg:text-sm text-blue-600 dark:text-blue-400">Total Entries</div>
            </div>
            <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 lg:p-4 text-center">
              ...
              <div className="text-xs lg:text-sm text-green-600 dark:text-green-400">Approved</div>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3 lg:p-4 text-center">
              ...
              <div className="text-xs lg:text-sm text-purple-600 dark:text-purple-400">Total Hours</div>
            </div>
          </div>
          ...
          {timeLogsLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No work history</h3>
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <div key={log.id} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        log.status === 'REJECTED' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' :
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{log.totalHours?.toFixed(1) || '0.0'}h</span>
                      </div>
                      {log.description && (
                        <div className="mt-2">
                          <span className="text-gray-500 dark:text-gray-400 text-xs">Description:</span>
                          <p className="text-gray-600 dark:text-gray-300 text-xs mt-1">{log.description}</p>
                        </div>
                      )}
                    </div>
                  </div>
