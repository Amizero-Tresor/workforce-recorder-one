          ...
          <>
            ...
            <div className="bg-gradient-to-r from-[#008080]/10 to-[#006666]/10 rounded-lg p-4 lg:p-6">
              <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">{project.name}</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                ...
                <div className="text-xl lg:text-2xl font-bold text-blue-900">{getWorkerCount()}</div>
              ...
              <div className="bg-green-50 rounded-lg p-4 text-center">
                ...
                <div className="text-xl lg:text-2xl font-bold text-green-900">{getTotalHours().toFixed(1)}h</div>
              ...
              <div className="bg-purple-50 rounded-lg p-4 text-center">
                ...
                <div className="text-xl lg:text-2xl font-bold text-purple-900">{timeLogs.length}</div>
                <div className="text-sm text-purple-700">Time Entries</div>
              </div>
            </div>

            {/* Assigned Workers */}
            {projectDetails?.workerProjects && projectDetails.workerProjects.length > 0 && (
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {projectDetails.workerProjects.map((wp: any) => (
                    <div key={wp.worker.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                      <div className="w-8 h-8 bg-gradient-to-br from-[#008080] to-[#006666] rounded-full flex items-center justify-center">
                        <span className="text-white font-medium text-xs">
                          {wp.worker.firstName[0]}{wp.worker.lastName[0]}
                        </span>
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-500 truncate">{wp.worker.email}</div>
                      </div>
                    </div>
                  ))}
                </div>
